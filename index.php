...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">kimhotelhanoi@gmail.com
</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>024 3255 5678</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="../index.php">KIM <span>HOTEL</span><p class="logo_w3l_agile_caption">Resort Hotel</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Nhân Viên</a></li>
							<li class="menu__item"><a href="gallery" class="menu__link scroll">Gallery</a></li>
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Phòng Nghỉ</a></li>
							<li class="menu__item"><a href="#contact" class="menu__link scroll">Liên Hệ</a></li>
							<li class="menu__item"><a href="admin" >Đăng nhập</a></li>
						</ul>
					</nav>
				</div>
			</nav>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Giới thiệu về KIM HOTEL</h3> 
						   <p class="about-para-w3ls">KIM HOTEL là nơi nghỉ dưỡng sau những bộn bề công việc ngoài ra nơi đây còn là nơi hẹn hò vô cùng lãng mạn, riêng tư trong một không gian bài trí tinh tế, ấn tượng</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Chúng tôi ở đây để làm hài lòng khách hàng </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">ĐỘI NGŨ NHÂN VIÊN</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
			...
			<div class="contact-agileits">
				...
				<form  method="post" name="sentMessage" id="contactForm" >
					<div class="control-group form-group">
                            ...
                            <label class="contact-p1">Tên đầy đủ:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Số điện thoại :</strong>024 3255 5678</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">kimhotelhanoi@gmail.com</a></p>
			<p class="contact-agile1"><strong>Địa chỉ :</strong> P.Yên Hoà, Q.Cầu Giấy, Hà Nội</p>
