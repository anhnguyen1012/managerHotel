...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">KIM HOTEL HOMEPAGE</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         echo '<script>alert("Tên tài khoản mật khẩu không chính xác") </script>' ;
      }
   }
?>
